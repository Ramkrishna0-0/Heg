module.exports = {
  OWNER_IDS: ["924531269784703026, 969489210006466570"], // Bot owner ID's
  SUPPORT_SERVER: "1165974148623896608", // Your bot support server
  PREFIX_COMMANDS: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1165974148623896608", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
  ...
  PRESENCE: {
    ...
    MESSAGE: ".help | 69 server", // Your bot status message
  },
